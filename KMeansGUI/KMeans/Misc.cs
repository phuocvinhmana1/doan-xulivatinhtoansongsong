...
namespace KMeansProject
{
    public static class Misc
    {
        ...
        static Misc()
        {
            // mang 1 chieu chua mau sac

            centroidColors = new Color[8];
            centroidColors[0] = Color.Red;
            centroidColors[1] = Color.Blue;
            centroidColors[2] = Color.Black;
            centroidColors[3] = Color.Tomato;
            centroidColors[4] = Color.Yellow;
            centroidColors[5] = Color.Green;
            centroidColors[6] = Color.Pink;
            centroidColors[7] = Color.SeaGreen;
        }
        ...
        public static double taoDiemNgauNhien(Random random, double minimum, double maximum)
        {
